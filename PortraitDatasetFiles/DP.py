...
folder_names = os.listdir("/data/vifapi/ameed_ahmed_thesis/HildesheimThesis/CSWin_Transformer_main/PortraitDataset/CenturyWiseOGData")
#styles = ['academicism','baroque','neoclassicism','orientalism','realism','Ukiyo_e']

for folder in folder_names:
    input_dir =  f'/data/vifapi/ameed_ahmed_thesis/HildesheimThesis/CSWin_Transformer_main/PortraitDataset/CenturyWiseOGData/{folder}'
    output_dir = f'/data/vifapi/ameed_ahmed_thesis/HildesheimThesis/CSWin_Transformer_main/PortraitDataset/CenturyWiseResizedData/{folder}'
