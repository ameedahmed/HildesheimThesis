...
parser.add_argument('--data', default='/data/vifapi/ameed_ahmed_thesis/HildesheimThesis/CSWin_Transformer_main/cropped_dataset', metavar='DIR',
...
def main():
    ...
    if not os.path.exists(train_dir):
        ...
        exit(1)
    dataset_train = McDataset(args.data, '/data/vifapi/ameed_ahmed_thesis/HildesheimThesis/CSWin_Transformer_main/cropped_dataset/train.txt', 'train')
    ...
    if not os.path.isdir(eval_dir):
        ...
        if not os.path.isdir(eval_dir):
            ...
            exit(1)
    dataset_eval = McDataset(args.data, '/data/vifapi/ameed_ahmed_thesis/HildesheimThesis/CSWin_Transformer_main/cropped_dataset/val.txt', 'val')
...
def validate(model, loader, loss_fn, args, amp_autocast=suppress, log_suffix='',epochs=None,confusion_matrix_folder_location=None):
    ...
    classes = ['Ukiyo_e','academicism','baroque','neoclassicism','orientalism','realism']
    ...
    classification_report_record = classification_report(all_labels, all_preds, target_names=classes, output_dict=True)    
